...
if (isset($_POST['signup'])) {
    ...
    function generateStudentID($file)
    {
        ...
        return 'SID' . str_pad($studentCount + 1, 4, '0', STR_PAD_LEFT);
    }
    $file = 'C:\xampp\htdocs\BookShelf\studentid.txt'; // Specify the file path
    chmod($file, 0644);
...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>BookShelf | Student Signup</title>
